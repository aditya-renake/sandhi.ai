  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-teal-500 selection:text-slate-900">
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-xs font-semibold text-rose-400 hover:text-rose-300 bg-rose-950/30 hover:bg-rose-950/60 px-3 py-1.5 rounded-lg border border-rose-800/50 transition"
            >
      ...
      <main className="max-w-6xl mx-auto px-4 py-8 flex-1 w-full space-y-8">
        ...
        <section className="bg-gradient-to-br from-slate-900 via-slate-900/90 to-teal-950/40 border border-slate-800/80 rounded-2xl p-6 shadow-xl relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
            <div className="flex items-start gap-4">
              <div className="w-14 h-14 rounded-2xl bg-teal-500/10 border border-teal-500/30 flex items-center justify-center text-teal-400 text-xl font-bold shrink-0">
              ...
              <div className="space-y-1">
                ...
                <p className="text-[11px] text-teal-300/80 pt-1 flex items-center gap-1.5">
            ...
            <div className="bg-slate-950/60 border border-slate-800 rounded-xl p-4 md:w-64 shrink-0">
            ...
            <div
              ...
              className={`cursor-pointer rounded-2xl border p-5 transition-all relative overflow-hidden flex flex-col justify-between group ${
                steps.step1?.completed
                  ...
                  : "bg-slate-900/70 border-slate-800 hover:border-teal-500/60 hover:shadow-[0_0_25px_rgba(20,184,166,0.15)]"
              }`}
            >
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold ${
                      steps.step1?.completed ? "bg-emerald-500/20 text-emerald-400 border border-emerald-500/40" : "bg-teal-500/10 text-teal-400 border border-teal-500/30"
                    }`}>
                  ...
                  {steps.step1?.completed ? (
                    <span className="text-xs px-2.5 py-1 rounded-full bg-emerald-950/70 border border-emerald-600/60 text-emerald-300 font-semibold flex items-center gap-1.5">
                      <CheckCircle2 className="w-3.5 h-3.5" />
                      Score: {steps.step1.score ?? 48}/100
                    </span>
                  ) : (
                    <span className="text-xs px-2.5 py-1 rounded-full bg-amber-950/50 border border-amber-600/50 text-amber-300 font-medium flex items-center gap-1">
                ...
                {steps.step1?.completed && steps.step1?.data && (
                  <div className="bg-slate-950/60 rounded-lg p-2.5 border border-slate-800 flex items-center justify-between text-xs text-slate-300">
              ...
              <div className="pt-4 flex items-center justify-between text-xs font-semibold text-teal-400 group-hover:text-teal-300 border-t border-slate-800/60 mt-4">
            ...
            >
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold ${
                      steps.step2?.completed ? "bg-emerald-500/20 text-emerald-400 border border-emerald-500/40" : "bg-teal-500/10 text-teal-400 border border-teal-500/30"
                    }`}>
            ...
            >
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center font-bold ${
                      steps.step3?.completed ? "bg-emerald-500/20 text-emerald-400 border border-emerald-500/40" : "bg-teal-500/10 text-teal-400 border border-teal-500/30"
                    }`}>
            ...
            >
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs px-2.5 py-1 rounded-full bg-teal-950 border border-teal-600/60 text-teal-300 font-semibold flex items-center gap-1">
                    Final Dossier
                  </span>
                </div>
                ...
                <div className="bg-slate-950/60 rounded-lg p-2.5 border border-slate-800 text-xs text-slate-400 flex items-center justify-between">
                  <span>Composite Risk: <strong className="text-amber-400 font-bold">Moderate OA (KL Grade 2)</strong></span>
                  <span className="text-emerald-400">Syncs to MDoNER Hub</span>
                </div>
              </div>

              <div className="pt-4 flex items-center justify-between text-xs font-semibold text-amber-400 group-hover:text-amber-300 border-t border-slate-800/60 mt-4">
          ...
          <section className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 space-y-4">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-xs text-left">
                <thead className="text-[11px] text-slate-400 bg-slate-950/60 uppercase font-mono border-b border-slate-800">
                  <tr>
        ...
        <div className="bg-slate-900/50 border border-amber-500/20 rounded-xl p-4 flex items-start gap-3 text-xs text-slate-400">
          <AlertCircle className="w-5 h-5 text-amber-400 shrink-0 mt-0.5" />
          <div>
            <p className="font-semibold text-slate-300">Statutory Clinical Notice (MDoNER / ICMR Tele-Medicine Guidelines):</p>
